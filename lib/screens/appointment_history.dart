                                                ...
                                                : _search.text.isNotEmpty
                                                    ? _searchResult.length > 0
                                                        ? ListView.builder(
                                                            ...
                                                            itemBuilder: (context, i) {
                                                              String sdate = DateUtil().formattedDate(DateTime.parse(_searchResult[i].date!));
                                                                                ...
                                                                                child: Container(
                                                                                    decoration: new BoxDecoration(
                                                                                        image: new DecorationImage(
                                                                                            ...
                                                                                            image: NetworkImage(_searchResult[i]
                                                                                                .user!
                                                                                                .fullImage!)))),
                                                                              ),
                                                                            ),
                                                                            title: Text(_searchResult[i].patientName!,
                                                                          ...
                                                                          child: Row(
                                                                            ...
                                                                            children: [
                                                                              Column(
                                                                                ...
                                                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                                                children: [
                                                                                  Text(getTranslated(context,hospital_name_heading).toString(),
                                                                                      style:
                                                                                      TextStyle(fontSize: 14, color: passwordVisibility)),
                                                                                  Text(_searchResult[i].hospital!.name!,
                                                                                      style: TextStyle(fontSize: 14, color: hintColor)),
                                                                                ],
                                                                              ),
                                                                              Column(
                                                                                ...
                                                                                crossAxisAlignment: CrossAxisAlignment.end,
                                                                                children: [
                                                                                  Text(getTranslated(context, hospital_address).toString(),
                                                                                      style:
                                                                                      TextStyle(fontSize: 14, color: passwordVisibility)),
                                                                                  Container(
                                                                                    width: 165,
                                                                                    margin: EdgeInsets.only(),
                                                                                    child: Text(_searchResult[i].hospital!.address!,
                                                                                      style: TextStyle(fontSize: 14, color: hintColor),overflow: TextOverflow.ellipsis,maxLines: 1,),
                                                                                  ),
                                                                                ],
                                                                              ),
                                                                            ],
                                                    ...
                                                    : ListView.builder(
                                                        ...
                                                        itemBuilder: (context, index) {
                                                          ...
                                                          String date = DateUtil().formattedDate(DateTime.parse(upcomingappointmentreq[index].date!));
                                                                          ...
                                                                          Column(
                                                                            ...
                                                                            children: [
                                                                              Text(getTranslated(context, hospital_name_heading).toString(),
                                                                                  style:
                                                                                      TextStyle(fontSize: 14, color: passwordVisibility)),
                                                                              upcomingappointmentreq[index].hospital!.name != null ?  Text(upcomingappointmentreq[index].hospital!.name!,
                                                                                  style: TextStyle(fontSize: 14, color: hintColor)) : Text('',
                                                                                  style: TextStyle(fontSize: 14, color: hintColor))
                                                                            ],
                                                                          ),
                                                                          Column(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Container(
                                                                                width: 165,
                                                                                margin: EdgeInsets.only(),
                                                                                child: Text(upcomingappointmentreq[index].hospital!.address!,
                                                                                    style: TextStyle(fontSize: 14, color: hintColor),overflow: TextOverflow.ellipsis,maxLines: 2,),
                                                                              ),
                                                                            ],
                                                                          ),
                                                                        ],
                                                ...
                                                : _search.text.isNotEmpty
                                                    ? _pastSearch.length > 0
                                                        ? new ListView.builder(
                                                            ...
                                                            itemBuilder: (context, i) {
                                                              String sdate = DateUtil().formattedDate(DateTime.parse(_pastSearch[i].date!));
                                                              var statusColor = status;
                                                                            ...
                                                                            children: [
                                                                              Column(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Container(
                                                                                    margin: EdgeInsets.only(left: 5),
                                                                                    child: _pastSearch[i].hospital!.name != null ? Text(_pastSearch[i].hospital!.name!,
                                                                                        style: TextStyle(fontSize: 14, color: hintColor)) : Text('',
                                                                                        style: TextStyle(fontSize: 14, color: hintColor)),
                                                                                  ),
                                                                                ],
                                                                              ...
                                                                              Column(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Container(
                                                                                      width: 165,
                                                                                      margin: EdgeInsets.only(),
                                                                                      child: _pastSearch[i].hospital!.address != null ? Text(_pastSearch[i].hospital!.address!,
                                                                                        style: TextStyle(fontSize: 14, color: hintColor),overflow: TextOverflow.ellipsis,maxLines: 2) : Text('',
                                                                                          style: TextStyle(fontSize: 14, color: hintColor))
                                                                                  ),
                                                                                ],
                                                                              ),
                                                                          ...
                                                                          Column(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Container(
                                                                                ...
                                                                                child: pastappointmentreq[index].hospital!.name != null ? Text(pastappointmentreq[index].hospital!.name!,
                                                                                    style: TextStyle(fontSize: 14, color: hintColor)) : Text('',
                                                                                    style: TextStyle(fontSize: 14, color: hintColor)),
                                                                              ),
                                                                            ],
                                                                            ...
                                                                            child: Column(
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                Container(
                                                                                  width: 165,
                                                                                  margin: EdgeInsets.only(),
                                                                                  child: pastappointmentreq[index].hospital!.address != null ? Text(pastappointmentreq[index].hospital!.address!,
                                                                                      style: TextStyle(fontSize: 14, color: hintColor),overflow: TextOverflow.ellipsis,maxLines: 2,) : Text('',
                                                                                      style: TextStyle(fontSize: 14, color: hintColor))
                                                                                ),
                                                                              ],
