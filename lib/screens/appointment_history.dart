                                    ...
                                    onTap: () {
                                      if (_drawerMenu[index] ==
                                        ...
                                        Navigator.popAndPushNamed(
                                          ...
                                          getTranslated(
                                                  context, drawer_callHistory)
                                              .toString()) {
                                        Navigator.popAndPushNamed(
                                            context, 'VideoCallHistory');
                                      } else if (_drawerMenu[index] ==
                                          getTranslated(context,
                                                  drawer_schedule_timing)
                                              .toString()) {
                                        Navigator.popAndPushNamed(
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  Column(
                                                                                    ...
                                                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                                                    children: [
                                                                                      Text(getTranslated(context, date_and_time).toString(), style: TextStyle(fontSize: 14, color: passwordVisibility)),
                                                                                      Row(
                                                                                        children: [
                                                                                          Text('$sdate', style: TextStyle(fontSize: 14, color: hintColor)),
                                                                                          SizedBox(width: 5),
                                                                                  ...
                                                                                  Column(
                                                                                    ...
                                                                                    children: [
                                                                                      Text(getTranslated(context, doctor_name).toString(), style: TextStyle(fontSize: 14, color: passwordVisibility)),
                                                                                      Container(
                                                                                        margin: EdgeInsets.only(),
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  Column(
                                                                                    ...
                                                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                                                    children: [
                                                                                      Text(getTranslated(context, hospital_name_heading).toString(), style: TextStyle(fontSize: 14, color: passwordVisibility)),
                                                                                      Text(_searchResult[i].hospital!.name!, style: TextStyle(fontSize: 14, color: hintColor)),
                                                                                    ],
                                                                                  ),
                                                                                  Column(
                                                                                    mainAxisAlignment: MainAxisAlignment.start,
                                                                                    crossAxisAlignment: CrossAxisAlignment.end,
                                                                                    children: [
                                                                                      Text(getTranslated(context, hospital_address).toString(), style: TextStyle(fontSize: 14, color: passwordVisibility)),
                                                                                      Container(
                                                                                        width: 165,
                                                                                        margin: EdgeInsets.only(),
                                                                                        child: Text(
                                                                                          _searchResult[i].hospital!.address!,
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Column(
                                                                                ...
                                                                                children: [
                                                                                  Text(getTranslated(context, hospital_name_heading).toString(), style: TextStyle(fontSize: 14, color: passwordVisibility)),
                                                                                  upcomingappointmentreq[index].hospital!.name != null ? Text(upcomingappointmentreq[index].hospital!.name!, style: TextStyle(fontSize: 14, color: hintColor)) : Text('', style: TextStyle(fontSize: 14, color: hintColor))
                                                                                ],
                                                                              ),
                                                                              Column(
                                                                                mainAxisAlignment: MainAxisAlignment.start,
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Container(
                                                                                    ...
                                                                                    margin: EdgeInsets.only(),
                                                                                    child: Text(
                                                                                      upcomingappointmentreq[index].hospital!.address!,
                                                                                      style: TextStyle(fontSize: 14, color: hintColor),
                                                                                      overflow: TextOverflow.ellipsis,
                                                                                      maxLines: 2,
                                                                                    ),
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  Column(
                                                                                    ...
                                                                                    crossAxisAlignment: CrossAxisAlignment.start,
                                                                                    children: [
                                                                                      Text("Hospital Name", style: TextStyle(fontSize: 14, color: passwordVisibility)),
                                                                                      Container(
                                                                                        margin: EdgeInsets.only(left: 5),
                                                                                        child: _pastSearch[i].hospital!.name != null ? Text(_pastSearch[i].hospital!.name!, style: TextStyle(fontSize: 14, color: hintColor)) : Text('', style: TextStyle(fontSize: 14, color: hintColor)),
                                                                                      ),
                                                                                    ],
                                                                                  ),
                                                                                  Column(
                                                                                    ...
                                                                                    crossAxisAlignment: CrossAxisAlignment.end,
                                                                                    children: [
                                                                                      Text("Hospital Address", style: TextStyle(fontSize: 14, color: passwordVisibility)),
                                                                                      Container(width: 165, margin: EdgeInsets.only(), child: _pastSearch[i].hospital!.address != null ? Text(_pastSearch[i].hospital!.address!, style: TextStyle(fontSize: 14, color: hintColor), overflow: TextOverflow.ellipsis, maxLines: 2) : Text('', style: TextStyle(fontSize: 14, color: hintColor))),
                                                                                    ],
                                                                                  ),
                                                                                ],
                                                                              ),
                                                                              ...
                                                                              Column(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Container(
                                                                                    ...
                                                                                    child: pastappointmentreq[index].hospital!.name != null ? Text(pastappointmentreq[index].hospital!.name!, style: TextStyle(fontSize: 14, color: hintColor)) : Text('', style: TextStyle(fontSize: 14, color: hintColor)),
                                                                                  ),
                                                                                ],
                                                                              ),
                                                                              Container(
                                                                                ...
                                                                                child: Column(
                                                                                  ...
                                                                                  children: [
                                                                                    ...
                                                                                    Container(
                                                                                        width: 165,
                                                                                        margin: EdgeInsets.only(),
                                                                                        child: pastappointmentreq[index].hospital!.address != null
                                                                                            ? Text(
                                                                                                pastappointmentreq[index].hospital!.address!,
                                                                                                style: TextStyle(fontSize: 14, color: hintColor),
                                                                                                overflow: TextOverflow.ellipsis,
                                                                                                maxLines: 2,
                                                                                              )
