                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              getTranslated(context, select_hospital).toString(),
                                              style: TextStyle(fontSize: width! * 0.04, color: hintColor),
                                            ),
                                            ListView.builder(
                                              shrinkWrap: true,
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        ...
                                                        TextField(
                                                          ...
                                                          controller: _college,
                                                          decoration:
                                                              InputDecoration(hintText: getTranslated(context, profile_dialog_education).toString()),
                                                        ),
                                                        TextField(
                                                          onChanged: (value) {
                                                            setState(() {
                                                          ...
                                                          inputFormatters: [new FilteringTextInputFormatter.allow(RegExp("[0-9]"))],
                                                          decoration: InputDecoration(
                                                              hintText: getTranslated(context, profile_dialog_year_of_completion).toString()),
                                                        ),
                                                      ],
                                                    ),
                                                  ),
                                                      ...
                                                      child: Column(
                                                        children: [
                                                          ...
                                                          TextField(
                                                            ...
                                                            inputFormatters: [new FilteringTextInputFormatter.allow(RegExp("[0-9]"))],
                                                            decoration:
                                                                InputDecoration(hintText: getTranslated(context, profile_dialog_year).toString()),
                                                          ),
                                                        ],
                                                      ),
                                                    ),
          ...
          onPressed: () {
            if (_currentStep == 0 && _step1.currentState!.validate()) {
              ...
              if (selectedHospitals.isNotEmpty) {
                ...
                Fluttertoast.showToast(msg: getTranslated(context, please_select_hospital).toString());
              }
