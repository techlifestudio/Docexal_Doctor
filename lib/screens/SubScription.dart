                                                    ...
                                                    1 >= parsedata.length
                                                      ...
                                                      crossAxisAlignment: CrossAxisAlignment.start,
                                                            ...
                                                            children: [
                                                              ...
                                                              Row(
                                                                children: [
                                                                  SharedPreferenceHelper.getString(Preferences.currency_symbol) != "N/A" ?   Text("${SharedPreferenceHelper.getString(Preferences.currency_symbol)} ${parsedata[0]['price']} /", style: TextStyle(
                                                                      fontWeight: FontWeight.bold,
                                                                      fontSize: 14,
                                                              ...
                                                              itemBuilder: (context, index) =>
                                                                  Container(
                                                                    ...
                                                                    child: RadioListTile(
                                                                      ...
                                                                      title: Row(
                                                                        children: [
                                                                          SharedPreferenceHelper.getString(Preferences.currency_symbol) != "N/A" ?   Text("${SharedPreferenceHelper.getString(Preferences.currency_symbol)} ${parsedata[index]['price']} /", style: TextStyle(
                                                                              fontWeight: FontWeight.bold,
                                                                              fontSize: 14,
