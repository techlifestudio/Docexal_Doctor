...
class _CancelAppointmentScreen extends State<CancelAppointmentScreen> {
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: Text(
                                getTranslated(
                                        context, cancel_appointment_heading)
                                    .toString(),
                                style: TextStyle(
                                                                ...
                                                                child: ListTile(
                                                                  ...
                                                                  leading:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child: Container(
                                                                          decoration:
                                                                              new BoxDecoration(image: new DecorationImage(fit: BoxFit.fitHeight, image: NetworkImage(caneclappointmentreq[index].user!.fullImage!)))),
                                                                    ),
                                                                  ),
                                                                  title:
                                                                      Container(
  ...
  Future<BaseModel<CancelAppointment>> cancelappointment() async {
    ...
    try {
      ...
      _userCancel.clear();
      response =
          await RestClient(RetroApi().dioData()).cancelappointmentrequest();
      setState(() {
  ...
  onSearchTextChanged(String text) async {
    ...
    _userCancel.forEach((appointmentCancel) {
      if (appointmentCancel.patientName!
          .toLowerCase()
